...
if __name__ == "__main__":
    ...
    contrastive_train_dataset = ContrastiveDataset(
        ...
        transform=Compose(train_transform, using_jukebox=True),
    )
    ...
    train_representations_dataset = contrastive_train_dataset
    # train_representations_dataset = module.extract_representations(train_loader)
    # train_representations_dataset = module.load_representations('train')  # using saved feature
    train_loader = DataLoader(
    ...
    valid_representations_dataset = contrastive_valid_dataset
    # valid_representations_dataset = module.extract_representations(valid_loader)
    # valid_representations_dataset = module.load_representations('valid')
    valid_loader = DataLoader(
    ...
    device = "cuda:1" if args.gpus else "cpu"
    results = evaluate(
        module.encoder,
        module.model,
        contrastive_test_dataset,
